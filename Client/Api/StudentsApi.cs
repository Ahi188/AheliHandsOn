...
namespace IO.Swagger.Api
{
    ...
    public interface IStudentsApi
    {
        ...
        /// <param name="id"></param>
        /// <returns>string</returns>
        string ApiStudentsDeleteStudentByIdDelete (int? id);
        /// <summary>
        ///  
        /// </summary>
        /// <param name="body"></param>
    ...
    public class StudentsApi : IStudentsApi
    {
        ...
        /// <param name="id"></param>
        /// <returns>string</returns>
        public string ApiStudentsDeleteStudentByIdDelete (int? id)
        {
    
            var path = "/api/Students/DeleteStudentById";
            path = path.Replace("{format}", "json");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling ApiStudentsDeleteStudentByIdDelete: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling ApiStudentsDeleteStudentByIdDelete: " + response.ErrorMessage, response.ErrorMessage);
