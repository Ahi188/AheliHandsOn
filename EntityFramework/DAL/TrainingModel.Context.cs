...
namespace EntityFramework.DAL
{
    ...
    public partial class TrainingEntitiesConnectionString : DbContext
    {
        public TrainingEntitiesConnectionString()
            : base("name=TrainingEntitiesConnectionString")
        {
        }
        ...
        [DbFunction("TrainingEntitiesConnectionString", "Fn_GetStudent")]
        public virtual IQueryable<Fn_GetStudent_Result> Fn_GetStudent()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Fn_GetStudent_Result>("[TrainingEntitiesConnectionString].[Fn_GetStudent]()");
        }
