...
using EntityFrameworkDotNetCore.DAL;
using System;
using System.Collections.Generic;

namespace EntityFrameworkDotNetCore
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            var studentlist = new List<StudentBO>();
            /*studentlist = dal.GetStudents();
            dal.CreateStudentWithSP(new BStudentBO
            {
                FirstName ="Ranen",
                LastName ="Ghosh",
                Roll=26,
